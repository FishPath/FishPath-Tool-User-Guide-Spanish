...
<!-- Missing: Hidden options are only shown when the toggle “Show Hidden Options” is on (red label 2 in Figure \@ref(fig:results-components))  -->
...
<!-- TODO: translate and assessment only in tiers -->
...
- **Ordenar por el “nivel de evaluación” (Assessment Only):** Ordena las opciones de acuerdo a su complejidad y requerimiento o demanda de datos 
...
<!-- TODO:translate caption and image -->
...
```{r results-review-header, echo=FALSE, fig.cap='Pantalla del proceso de reducir resultados.', fig.align='center', out.width='95%', fig.show='hold'}
...
<!-- TODO: Should add english text since these are buttons in the tool? -->
<!-- TODO: check if sentence is stating fishery is view only-->
